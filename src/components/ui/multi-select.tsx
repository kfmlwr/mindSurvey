...
export function MultiSelectContent({
  ...
  const searchPlaceholder = typeof search === "object" ? search.placeholder : undefined
  const searchEmptyMessage = typeof search === "object" ? search.emptyMessage : emptyMessage
